...
<div className='body'>  
        ...
        <div className='background-desc'>
            <div className='back-desc'>
                ...
                <p className='desc-detail'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam asperiores explicabo earum quaerat pariatur sint voluptates modi magnam, facilis sapiente assumenda, reprehenderit obcaecati veritatis labore? At odit vel quos unde!</p>
            </div>
        </div>
